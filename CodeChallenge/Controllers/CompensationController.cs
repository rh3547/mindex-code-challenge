...
namespace CodeChallenge.Controllers
{
    ...
    public class CompensationController : ControllerBase
    {
        ...
        {
            _logger.LogDebug($"Received compensation create request for employee '{compensationAddDTO.EmployeeId}'");

            Compensation compensation = _compensationService.Create(compensationAddDTO);
        ...
        [HttpGet("employee/{employeeId}", Name = "getCompensationByEmployeeId")]
        public IActionResult GetCompensationByEmployeeId(String employeeId)
        {
            ...
            Compensation compensation = _compensationService.GetByEmployeeId(employeeId);
            if (compensation == null) return NotFound();
